...
/// <summary>
/// Descripción breve de DatosRecinto
/// </summary>
public class DatosRecinto
{
    public static bool AgregarRecinto(Recinto obj)
    {
        try
        {
            bool agregado;
            ...
            using (SqlConnection conn = new SqlConnection(servidor))
            {
                using (SqlCommand cmd = new SqlCommand
                {
                    ...
                    CommandText = "P_REGISTRAR_RECINTO"
                })
                {
                    ...
                    {
                        throw new Exception("Error al agregar Recinto");
                    }
                    conn.Close();
                }
            }
    ...
    public static DataTable ListarRecinto()
    {
        try
        {
            Conexion c = new Conexion();
            ...
            SqlDataAdapter da = new SqlDataAdapter("P_LISTAR_RECINTO", dataConnection);
            dataConnection.Open();
