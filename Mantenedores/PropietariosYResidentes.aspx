<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PropietariosYResidentes.aspx.cs" Inherits="Mantenedores_PropietariosYResidentes" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <h3 runat="server" style="text-align:center;">Registrar <br /> Propietarios y residentes</h3>
            <div class="divDetalle">
                ...
                <div class="form-row">
                    ...
                    <div class="divTextos txtComuna form-group col-md-4">
                        <asp:Label ID="Label12" runat="server" Text="Comuna"></asp:Label>
